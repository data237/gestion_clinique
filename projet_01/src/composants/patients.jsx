                    ...
                    {/*<div className='conteneur-tableau-2'>*/}
                        <table className='tableau-2'>
                            ...
                            <tr key={patient.id} >
                                ...
                                <td onClick={() => handleRowClick(patient)}>{patient.prenom}</td>
                                <td onClick={() => handleRowClick(patient)}>{patient.email}</td>
                                <td onClick={() => handleRowClick(patient)}>{patient.telephone}</td>
                                <td onClick={() => handleRowClick(patient)}>{patient.dateNaissance}</td>
                                <td onClick={() => handleRowClick(patient)}>{patient.adresse}</td>
                                <td onClick={() => handleRowClick(patient)}>{patient.genre}</td>
